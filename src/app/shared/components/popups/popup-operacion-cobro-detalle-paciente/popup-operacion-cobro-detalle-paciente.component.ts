...
@Component({
  selector: 'app-popup-operacion-cobro-detalle-paciente',
  templateUrl: './popup-operacion-cobro-detalle-paciente.component.html',
  styleUrls: ['./popup-operacion-cobro-detalle-paciente.component.css'],
  providers: [MessageService,DialogService]
})
export class PopupOperacionCobroDetallePacienteComponent implements OnInit {
...
console.log(this.config.data);
  try {
      this.miServicio.getOperacionCobroRegistrosByPaciente(this.config.data.paciente_id)
      .subscribe(resp => {
        console.log(resp);
        if (resp[0]) {
          this.elementos = resp;
