...
@Component({
  selector: 'app-operacion-cobro-detalle-medico',
  templateUrl: './operacion-cobro-detalle-medico.component.html',
  styleUrls: ['./operacion-cobro-detalle-medico.component.css'], 
  providers: [MessageService,DialogService]
})
export class OperacionCobroDetalleMedicoComponent implements OnInit {
  ...
  loadRegistro(){
    ...
    try {
        this.miServicio.getOperacionCobroRegistrosBetweenDatesAndMedico(this._fechaDesde,this._fechaHasta,'PEN',userData['id'])    
        .subscribe(resp => {
          if (resp[0]) {
