...
@Component({
  selector: 'app-gerencia-detalle-operacion-cobro',
  templateUrl: './gerencia-detalle-operacion-cobro.component.html',
  styleUrls: ['./gerencia-detalle-operacion-cobro.component.css'], 
  providers: [MessageService,DialogService]
})
export class GerenciaDetalleOperacionCobroComponent implements OnInit {
  ...
  result_distribucion:any[];
    ...
    for(i=0;i<vals.length;i++){
      this.total_seleccionado = this.total_seleccionado+ Number(vals[i]['valor_facturado']);
  }
      }
      ...
      .subscribe(resp => {
        ...
        if(resp != 0){
          ...
          swal({
            toast: false,
            type: 'success',
            title: 'Se auditaron con éxito '+resp+' registros',
