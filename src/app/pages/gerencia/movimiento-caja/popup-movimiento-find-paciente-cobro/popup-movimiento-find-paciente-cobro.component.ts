...
@Component({
  selector: 'app-popup-movimiento-find-paciente-cobro',
  templateUrl: './popup-movimiento-find-paciente-cobro.component.html',
  styleUrls: ['./popup-movimiento-find-paciente-cobro.component.css']
})
export class PopupMovimientoFindPacienteCobroComponent implements OnInit {
  ...
  _forma_pago: any[] = [];
    ...
    constructor(private miServicio:PracticaService,private miServico:PacienteService,private messageService: MessageService ,public dialogService: DialogService, 
      private cp: CurrencyPipe,public ref: DynamicDialogRef, public config: DynamicDialogConfig, private filter: Filter   ) {
        ...
        onRowSelect(event) {  
            this.selectedItemPaciente = event.data;
            console.log(this.selectedItemPaciente);         
            this.loadList();
        }
