...
@Component({
  selector: 'app-listado-cirugia-quirofano-consulta',
  templateUrl: './listado-cirugia-quirofano-consulta.component.html',
  styleUrls: ['./listado-cirugia-quirofano-consulta.component.css'],
  providers: [MessageService,DialogService]
})
export class ListadoCirugiaQuirofanoConsultaComponent implements OnInit {
