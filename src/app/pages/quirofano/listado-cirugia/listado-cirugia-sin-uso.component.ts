...
@Component({
  selector: 'app-listado-cirugia-sin-uso',
  templateUrl: './listado-cirugia-sin-uso.component.html',
  styleUrls: ['./listado-cirugia-sin-uso.component.css'],
  providers: [MessageService,DialogService]
})
export class ListadoCirugiaSinUsoComponent implements OnInit {
