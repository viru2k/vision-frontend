...
@Component({
  selector: 'app-listado-cirugia-quirofano',
  templateUrl: './listado-cirugia-quirofano.component.html',
  styleUrls: ['./listado-cirugia-quirofano.component.css'],
  providers: [MessageService,DialogService]
})
export class ListadoCirugiaQuirofanoComponent implements OnInit {
