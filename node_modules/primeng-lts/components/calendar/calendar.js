...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.onMonthSelect = function (event, index) {
        if (!domhandler_1.DomHandler.hasClass(event.target, 'ui-state-disabled')) {
