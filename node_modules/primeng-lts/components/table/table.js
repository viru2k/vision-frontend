        ...
        if (stateString) {
            ...
            if (state_1.selection) {
                Promise.resolve(null).then(function () {
                    _this.selectionChange.emit(state_1.selection);
                });
            }
...
var ScrollableView = /** @class */ (function () {
    ...
    ScrollableView.prototype.ngAfterViewInit = function () {
        ...
        if (!this.frozen) {
            ...
            if (this.scrollableAlignerViewChild && this.scrollableAlignerViewChild.nativeElement) {
                this.scrollableAlignerViewChild.nativeElement.style.height = domhandler_1.DomHandler.calculateScrollbarHeight() + 'px';
            }
        ...
        if (this.dt.virtualScroll) {
            requestAnimationFrame(function () {
                if (_this.lastBodyScrollTop !== _this.scrollBodyViewChild.nativeElement.scrollTop) {
                    ...
                    var viewport = domhandler_1.DomHandler.getOuterHeight(_this.scrollBodyViewChild.nativeElement);
                    var tableHeight = domhandler_1.DomHandler.getOuterHeight(_this.scrollTableViewChild.nativeElement);
                    var pageHeight_1 = _this.dt.virtualRowHeight * _this.dt.rows;
                    var virtualTableHeight = domhandler_1.DomHandler.getOuterHeight(_this.virtualScrollerViewChild.nativeElement);
    ...
    __decorate([
        core_1.ViewChild('scrollableAligner', { static: false }),
        __metadata("design:type", core_1.ElementRef)
