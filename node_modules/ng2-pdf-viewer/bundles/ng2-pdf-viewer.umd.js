    ...
    ***************************************************************************** */
    ...
    var PdfViewerComponent = /** @class */ (function () {
        ...
        PdfViewerComponent.prototype.updateSize = function () {
            ...
            this._pdf
                ...
                if (!_this._originalSize ||
                    (_this._fitToPage &&
                        viewport.width > _this.element.nativeElement.offsetWidth)) {
                    scale = _this.getScale(page.getViewport({ scale: 1 }).width);
        ...
        PdfViewerComponent.prototype.loadPDF = function () {
            ...
            var loadingTask = PDFJS.getDocument(this.getDocumentParams());
        ...
        PdfViewerComponent.prototype.getScale = function (viewportWidth) {
            ...
            return ((this._zoom * (offsetWidth / viewportWidth)) /
