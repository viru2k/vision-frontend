...
export declare class BaseTooltip extends ChartData {
    ...
    createTooltip(chart: Chart | AccumulationChart, isFirst: boolean, location: ChartLocation, clipLocation: ChartLocation, point: Points | AccPoints, shapes: ChartShape[], offset: number, bounds: Rect, extraPoints?: PointData[], templatePoint?: Points | AccPoints, customTemplate?: string, tooltipPosition?: TooltipPosition): void;
    private getPositionBySize;
    private isTooltipFitPosition;
