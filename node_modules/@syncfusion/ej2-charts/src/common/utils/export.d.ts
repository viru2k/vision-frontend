...
export declare class ExportUtils {
     ...
     * @param fileName
     */
    export(type: ExportType, fileName: string, orientation?: PdfPageOrientation, controls?: (Chart | AccumulationChart | RangeNavigator | StockChart | BulletChart)[], width?: number, height?: number, isVertical?: boolean): void;
    /**
     * To get data url for charts.
     */
    getDataUrl(chart: Chart): {
