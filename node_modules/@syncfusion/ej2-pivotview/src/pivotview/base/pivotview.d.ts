...
import { PivotEngine, IPivotValues, IDataSet } from '../../base/engine';
import { IPageSettings, IGroupSettings, IGridValues } from '../../base/engine';
...
export declare class PivotView extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    /** @hidden */
    updateBlazorData(data: any, control?: PivotView): void;
    /** @hidden */
    frameContent(pivotValues: IPivotValues, type: string, rowPosition: number, control: PivotView): IGridValues;
    ...
    /** @hidden */
    updateGroupingReport(newGroupSettings: IGroupSettings[], updateGroupType: GroupType): void;
    private wireEvents;
