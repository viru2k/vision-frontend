 ...
 */
export declare class PivotChartSeriesBorder {
    /**
     * The color of the border that accepts value in hex and rgba as a valid CSS color string.
     * @default ''
     */
...
export declare class PivotChartSeriesAnimation {
    /**
     * If set to true, series gets animated on initial loading.
     * @default true
     */
...
export declare class PivotChartSeriesSegment {
    /**
     * Defines the starting point of region.
     * @default null
     */
...
export declare class PivotChartSeriesMarkerSettings {
    /**
     * If set to true the marker for series is rendered. This is applicable only for line and area type series.
     * @default false
     */
...
export declare class PivotChartSeriesErrorSettings {
    /**
     * If set true, error bar for data gets rendered.
     * @default false
     */
...
export declare class PivotChartSeriesTrendline {
    /**
     * Defines the name of trendline
     * @default ''
     */
...
export declare class PivotChartSeriesEmptyPointSettings {
    /**
     * To customize the fill color of empty points.
     * @default null
     */
...
export declare class PivotChartSeriesCornerRadius {
    /**
     * Specifies the top left corner radius value
     * @default 0
     */
 ...
 */
export declare class PivotChartAxisFont {
    /**
     * FontStyle for the text.
     * @default 'Normal'
     */
...
export declare class PivotChartAxisCrosshairTooltip {
    /**
     * If set to true, crosshair ToolTip will be visible.
     *  @default false
     */
...
export declare class PivotChartAxisMajorTickLines {
    /**
     * The width of the tick lines in pixels.
     * @default 1
     */
...
export declare class PivotChartAxisMajorGridLines {
    /**
     * The width of the line in pixels.
     * @default 1
     */
...
export declare class PivotChartAxisMinorTickLines {
    /**
     * The width of the tick line in pixels.
     * @default 0.7
     */
...
export declare class PivotChartAxisMinorGridLines {
    /**
     * The width of the line in pixels.
     * @default 0.7
     */
...
export declare class PivotChartAxisAxisLine {
    /**
     * The width of the line in pixels.
     * @default 1
     */
...
export declare class PivotChartAxisStripLineSettings {
    /**
     * If set true, strip line for axis renders.
     * @default true
     */
...
export declare class PivotChartAxisLabelBorder {
    /**
     * The color of the border that accepts value in hex and rgba as a valid CSS color string.
     * @default ''
     */
 ...
 */
export declare class PivotChartSettingsChartArea {
    /**
     * Options to customize the border of the chart area.
     */
    border: PivotChartBorderModel;
...
export declare class PivotChartSettingsCrosshairSettings {
    /**
     * If set to true, crosshair line becomes visible.
     * @default false
     */
...
export declare class PivotChartSettingsLegendSettings {
    /**
...
export declare class PivotChartSettingsIndexes {
    /**
     * Specifies the series index
     * @default 0
     * @aspType int
...
export declare class PivotChartSettingsMargin {
    /**
     * Left margin in pixels.
     * @default 10
     */
 ...
 */
export declare class PivotSeries extends ChildProperty<PivotSeries> {
    /**
 ...
 */
export declare class PivotAxis extends ChildProperty<PivotAxis> {
    /**
 ...
 */
export declare class PivotTooltipSettings extends ChildProperty<PivotTooltipSettings> {
    /**
 ...
 */
export declare class PivotZoomSettings extends ChildProperty<PivotZoomSettings> {
    /**
 ...
 */
export declare class ChartSettings extends ChildProperty<ChartSettings> {
    /**
